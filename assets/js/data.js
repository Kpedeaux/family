...
(function (global) {
  ...
  const P = {
    ...
    pierreNuma: {
      ...
      evidence: 'verified',
      branch: 'pedeaux',
      blurb: 'Baptised 11 May 1848. Buried St. Philomena Cemetery, Labadieville. Orphaned at fourteen, and taken in with his four younger siblings by his mother’s family — the 1870 census puts all five of them in the house of OLIVIER CANCIENNE. This page used to say Numa headed that household himself; he did not.',
      records: [
        {
        ...
        {
          title: 'THE ORPHANS WERE TAKEN IN BY THEIR MOTHER\u2019S FAMILY — the 1870 census, and there is no mother in it',
          text: 'Ward 5, Assumption Parish, page 63, HOUSEHOLD 118. The head is OLIVIER CANSIENE — Cancienne — aged 57, born about 1813 in Louisiana. Living with him: NUMA PEDOU 22, ALCEÉ 21, ULYSSE 20, ALICE 18 and FLORENCE 16. Five Pedeaux children in a Cancienne’s house, and NO ADULT PEDEAUX WOMAN ANYWHERE IN THE HOUSEHOLD.',
          highlight: 'THIS SETTLES TWO THINGS AND CORRECTS A THIRD. It settles that his mother was dead by 1870, which is what the 1862 burial of Marie Cancienne says — so that burial entry does belong to her after all, and the woman called “Mary Pedaux” in the 1900 census is somebody else. It settles who raised them: not strangers, but their MOTHER’S OWN KIN, an Olivier Cancienne old enough at 57 to be her brother. And it corrects this archive, which said Numa headed that household of four younger siblings at twenty-two. He did not head it. He was living in it.',
    ...
    eulalieBorne: {
      ...
      evidence: 'verified',
      branch: 'pedeaux',
      blurb: 'Named with both her parents in her own 1871 marriage record. Her people came off the German Coast — but they were not German.',
      records: [
        {
          title: 'THE BORNES WERE FRENCH, NOT GERMAN — despite the German Coast',
          citation: 'Albert J. Robichaux Jr., German Coast Families (1997), as abstracted on WikiTree and corroborated at the Pitre Trail genealogy',
          text: 'JACQUES ANTOINE BORNE, baptised at VALENCIENNES in Nord, France, 15 May 1697, son of Michel LEBORNE and Marie Jeanne ANART. He sailed aboard LA MARIE and landed at Dauphin Island on 25 AUGUST 1718, to work the Demeuves Concession on what became the German Coast. He is in the 1727 census on the right bank of the Mississippi, at Anse aux Outardes by 1731, and moved to the west bank near Hahnville after a raid in 1748.',
          highlight: 'A NAME THAT LOOKS GERMAN AND IS NOT, WHICH IS THE WHOLE POINT OF SAYING SO. The Bornes lived on the Côte des Allemands, and they turn up in a book called German Coast Families, and both of those facts have persuaded people that they were German. They were not. Jacques Antoine Borne was baptised in a French town, sailed on a French ship, and arrived in August 1718 — THREE YEARS BEFORE the German recruitment that gave the coast its name. He was there for a French concession. And the surname is absent from the roll of gallicised German pioneer names that everyone in Louisiana knows — Zweig became LaBranche, Huber became Oubre, Himmel became Hymel. Borne was never anything but Borne. Living somewhere is not the same as being from there, and a family history that skips that distinction gets a whole nationality wrong.'
        }
      ],
      sources: [
    ...
    marieCancienne: {
      ...
      evidence: 'verified',
      branch: 'pedeaux',
      blurb: 'Widowed in 1858, dead four years later at forty. Her five children went to a Cancienne — her own family. Her eldest son Numa was fourteen. The 1860 census caught her in between, holding a twelve-thousand-dollar farm together with her brother\'s help and four of her five children in school — a woman who could not read or write herself.',
      records: [
        {
          title: 'THE CANCIENNES WERE VENETIANS — a new country on this tree',
          citation: 'Steven A. Cormier, Acadians in Gray, family histories, classifying the family "Italian Creole" and citing Diocese of Baton Rouge Catholic Church Records 2:172 and Hébert, Acadian Families in Exile 1785, pp. 60–61',
          text: '"Pietro, son of Giorgio CANCIENI and Margherita Catharina YEARNE of VENICE, ITALY, married, in his early 30s, Jean-Marguerite, called Marguerite, 21-year-old daughter of the Acadian Joseph LANDRY and his second wife Jeanne-Madeleine-Marie VARANGUE, a Frenchwoman from Cherbourg, at Ascension in February 1786. … Pietro and Marguerite settled on upper Bayou Lafourche in what became Assumption and Lafourche parishes. Pietro\'s name evolved into PIERRE CANCIENNE in francophone Louisiana."',
          highlight: 'AN ITALIAN LINE NOBODY ON THIS TREE KNEW WAS HERE. The Brunetti side has always been the Italian story — Plataci, Calabria, a village that spoke Albanian. But the Canciennes were Venetians, in Louisiana by 1786, a full century and a quarter before John Brunetti stepped off a boat, and they entered this family through Bayou Lafourche rather than through New Orleans. Pietro Cancieni married an Acadian exile\'s daughter and became Pierre Cancienne, which is exactly what Louisiana did to foreign names. Roughly four in five Americans carrying the surname still live in Louisiana. ONE CAUTION PRINTED HERE ON PURPOSE: "Margherita Catharina Yearne" is not a plausible Venetian surname as spelled and is very likely a mis-transcription. The Baton Rouge record at 2:172 should be read before that name is repeated anywhere.'
        },
        {
          title: 'THE WIDOW\'S HOUSEHOLD — $12,000, four children in school, and a brother who was a cooper',
    ...
    michelPedeau: {
      ...
      records: [
        {
          title: 'THE 1810 CENSUS — and the Canciennes were the house next door',
          citation: 'United States Census, 1810 — Assumption Parish, Louisiana, microfilm M252-10, page 30, line 3, enumerated by B. Hullard, Junior. USGenWeb Census Project transcription by Audrey B. Westerman, proofread by David J. Valenziano.',
          text: 'Line 3: "Peddos, Michel." Line 4, the very next household on the enumerator\'s walk: "CANSIEN, PIERRE." The schedule\'s last column counts enslaved people. FOR MICHEL PEDEAU IT IS BLANK, and for Pierre Cancienne it is blank too. Several neighbours on the same page are not blank — Cossaivier holds 12, and Bourg, Riche and Aucoin hold 4 apiece.',
          highlight: 'THE MARRIAGE THAT MADE THIS FAMILY WAS ARRANGED BY A FENCE LINE. Thirty-seven years after this page was written, Michel\'s son Antoine Florentin married Marie Antoinette Cancienne. Here, in 1810, the two households are consecutive entries — a French shipwright\'s son from Nantes and a Venetian\'s son, farming side by side on the same stretch of Bayou Lafourche, both of them with nothing in the slaveholding column. The Acadian farms of that bayou ran five arpents of frontage by forty deep, side by side down the water, so "next on the page" means what it sounds like. And the timing matters: sugar had not arrived. Ribbon cane only replaced the delicate Creole variety here in 1824, and Assumption Parish did not make sugar its principal crop until 1861. Michel farmed a bayou of small mixed holdings. His grandsons grew up inside an industrial sugar parish.'
        },
        {
    ...
    charlesEmileLarmann: {
      ...
      records: [
        ...
        },
        {
          ...
          highlight: 'THIS CHANGES WHAT THE TWO OF THEM WERE. They have been on this page as "two unmarried aunts" — a phrase that quietly suggests dependence, women at the edge of somebody else\'s household. They were nothing of the kind. Leontine Victoria Moore spent FORTY YEARS in a New Orleans public school classroom, at McDonogh No. 16, one of the schools built from the John McDonogh bequest. The 1940 census has the pair of them owning their house outright at $2,200 with no man in it. So the boy who lost his father at eighteen months and his mother at eighteen years was not taken in out of charity by spinster relatives — he was raised in a house bought and held by two self-supporting women, one of them a career schoolteacher. That is the household Charles Emile Larmann grew up in, and it is worth saying plainly instead of leaving it as an aside.'
        },
        {
          title: 'HIS FUNERAL WAS AT ST. VINCENT DE PAUL — from his daughter and his nephew',
          text: 'Kevin\u2019s mother and his grandfather both say Charlie Larmann\u2019s funeral was held at ST. VINCENT DE PAUL CHURCH, 3051 Dauphine Street in Bywater — the church that is now Blessed Seelos, and the church where Kevin himself was married. He died 13 July 1969.',
          highlight: 'IT FITS WHAT THE DOCUMENTS ALREADY SHOW, WHICH IS WHY IT IS WORTH RECORDING. He is buried in ST. VINCENT DE PAUL CEMETERY NO. 1, in the tomb inscribed “FAMILY OF JOSEPH GOUBLER” — his own line, through his grandmother Valentine Goubler Moore. A funeral at the parish church followed by burial in the parish ground a few blocks away is the ordinary shape of a Catholic burial in that neighbourhood, and here both halves are accounted for. It also makes his 1924 marriage the first one to look for in the parish register.',
          citation: 'FAMILY TESTIMONY — told to Kevin Pedeaux by his mother and his grandfather, August 2026. NOT A DOCUMENT. The parish register would confirm it; the Louisiana civil records never name the church, so no index can.'
        },
        {
    ...
    johnCasparLarmann: {
      ...
      records: [
        ...
        {
          title: '710 LOVE STREET — AND THE WELLMEYERS WERE ALREADY ON THE BLOCK',
          text: 'LOVE STREET WAS RENAMED NORTH RAMPART. It was the prolongment of Rampart below Esplanade, through Faubourg Marigny and Bywater, renamed when the city consolidated the two into North Rampart Street. That is why the 1880 death act puts Casper at 710 LOVE STREET and the 1883 directory puts him at 710 N. RAMPART: one house, two street names, exactly the pattern as Enghein to Lafayette to Almonaster to Franklin. In 1884 he is a little further along the same street at 795 N. Rampart.',
          highlight: 'NOW SET THOSE NUMBERS BESIDE ONE ALREADY IN THIS ARCHIVE. B. H. WELLMEYER\u2019S GROCERY WAS 761 N. RAMPART — which the 1875 directory locates by name as “CLOUET, NE. COR. N. RAMPART.” So the pre-1894 numbers run 710 (Casper, 1880 and 1883), 761 (the Wellmeyer store, 1866 to 1884), 795 (Casper, 1884). Casper’s two addresses sit either side of the Wellmeyer grocery on the same street, in the same years. JOHN LARMANN SR. MARRIED ANN WELLMEYER IN 1947. Sixty-seven years earlier their families were a few doors apart on North Rampart — the second time this archive has caught these two lines standing next to each other long before they married, after both grandfathers turned up in IBEW Local 130.',
          citation: '[VERIFIED against the original, August 2026 — see the verification log] Orleans Parish death act, 16 April 1880 (710 Love Street, document image in this repository); Soards\u2019 and Polk\u2019s directories 1875, 1876, 1878, 1883, 1884. Street history: Love Street as the continuation of Rampart below Esplanade — New Orleans Historical (neworleanshistorical.org) and Building Antebellum New Orleans. NOT YET PINNED ON THE MAP: pre-1894 house numbers do not convert to modern ones without a numbered map, and the Sanborn plate for this stretch has not been read yet. The Clouet corner is the only reliable locator so far.'
        },
        {
        ...
        {
          title: '32 INDEPENDENCE, FOUND ON A FIRE MAP — and the house was already gone',
          citation: 'Sanborn Fire Insurance Map from New Orleans, Louisiana, 1893, Vol. IV, plate 148 — Library of Congress, Geography and Map Division, g4014nm g03376189304. Located via the volume\'s own street index: "Independence, 1–64 … 148." Modern block identified from the surveyed Independence × Royal and Independence × Chartres intersections.',
          text: 'Plate 148 covers Independence Street from the Mississippi levee up to Dauphine. On the block between ROYAL and CHARTRES the surveyor wrote the house numbers along both sides: 37, 35, 33, 31, 25 and 19 on the odd side, and 30, 20, 18 and 12½ on the even side. Above number 30, running all the way to the Royal Street corner, there are no buildings at all. The lot is drawn as an open yard and lettered LUMBER PILES.',
          image: 'assets/img/sanborn-1893-independence.jpg',
          imageAlt: 'A detail of the 1893 Sanborn fire insurance map of New Orleans, plate 148, showing Independence Street between Royal and Chartres with house numbers 37, 35, 33, 31, 25 and 19 on one side, 30, 20 and 18 on the other, and an open lot marked LUMBER PILES at the Royal Street corner',
          imageCredit: 'Sanborn Fire Insurance Map from New Orleans, 1893, Vol. IV, plate 148 — Library of Congress, Geography and Map Division. Public domain. Tap to enlarge.',
          highlight: 'HE LIVED THERE IN 1878. FIFTEEN YEARS LATER IT WAS A WOODPILE. The 1878 directory puts him at 32 Independence, and 32 is an even number, so it belongs on the side with 30, 20 and 18 — and it falls between number 30 and the Royal Street corner. That is precisely the ground the 1893 surveyor drew as an open lumber yard. Either the house came down to make the yard, or the numbering shifted before the survey; the map cannot tell which, and this page will not pretend it can. WHERE IT WAS, IN MODERN TERMS: the surveyed intersections put Independence × Chartres at 29.96113, -90.03959 and Independence × Royal at 29.96211, -90.03930, which makes that stretch THE 600 BLOCK OF INDEPENDENCE STREET today. Casper\'s house stood at the Royal Street end of it, on the side toward Congress. WHY THIS TOOK A FIRE MAP AT ALL: the 1878 number is useless on a modern map, because New Orleans renumbered every street in 1894. The Sanborn is the way around that — it was surveyed under the OLD numbers, it draws every building, and its own index will tell you which plate a given house number sits on. The 1885 volumes do not reach this street; the 1893 supplement does.'
        },
        {
    ...
    henryBernardWellmeyer: {
      ...
      records: [
        ...
        },
        {
          ...
          citation: '[VERIFIED against the original, August 2026 — see the verification log] Find a Grave memorial 177528019 (findagrave.com/memorial/177528019/bernard-henry-wellmeyer), read 12 August 2026; cemetery attribution is Find a Grave\u2019s and is user-contributed — the interment book itself has not been seen'
        },
        {
