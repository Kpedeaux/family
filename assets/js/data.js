...
(function (global) {
  ...
  const P = {
    ...
    charlesEmileLarmann: {
      ...
      records: [
        {
          title: 'THE HUNT FOR THE AUNTS\' HOUSE — two addresses found, and neither one is Franklin Avenue',
          citation: 'United States Census, 1910 — New Orleans Ward 9, ED 132, sheet 7A, dwelling 126, family 142 (NARA T624). United States Census, 1940 — New Orleans Ward 9, ED 36-246, Tract 12 part, sheet 11A, line 38, household 255 (NARA T627). Searched 12 August 2026.',
          text: '1910 — house number 927, street written down the margin as "LAFAYETTE STREET": VALENTINE MOORE, 62, widowed, head — the aunts\' mother — with LOUISE, 30, and LEONTINE, 27, both single, at home. Charles was seven. · 1940 — house number 727: LEONTINE MOORE, 60, head, single, with LOUISE MOORE, 62, sister. They owned it, valued at $2,200, and had been in the same house since at least 1935. The street on that sheet reads as Almonaster.',
          highlight: 'THIS IS A HONEST FAILURE, RECORDED RATHER THAN HIDDEN. The family remembers the aunts\' house on FRANKLIN AVENUE — John Larmann Sr. pointed it out to his grandson. Two censuses now give two house numbers for that household, thirty years apart, and neither sheet says Franklin. Worse, the 1910 street cannot be put on a map at all: there is a Lafayette Street in New Orleans today, but it runs through the Central Business District, a mile and a half from Ward 9. The name did not survive, or it was never quite that. So nothing has been plotted, because a pin in the wrong neighbourhood is worse than no pin. WHAT IS ACTUALLY LEFT TO CHECK, in order of promise: the 1920 and 1930 censuses of this household, which fall exactly in the years Charles was living with them and have not been found yet; Leontine\'s voter registrations of 1927, 1931 and 1941, which carry a residence address on the card; and her 1947 obituary and Louise\'s in 1948, which in New Orleans papers of that era almost always give the house.'
        },
        {
          title: 'Louisiana birth record',
